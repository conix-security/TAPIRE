...
def encoding_menu(symbols,symbol_selector):
    ...
    enconding_menu_choice(symbols,symbol_selector,encoding_selector)

def enconding_menu_choice(symbols,symbol_selector,encoding_selector):
    ...
    add_encoding_function(symbols,symbol_selector,encoding)

def add_encoding_function(symbols, symbol_selector,encoding):
